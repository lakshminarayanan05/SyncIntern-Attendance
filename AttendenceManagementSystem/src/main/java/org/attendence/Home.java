...
public class Home{
    ...
    public void homeView(int id) throws SQLException {
        ...
        x.setForeground(Color.decode("#fff67a"));
        ...
        min.setForeground(Color.decode("#fff67a"));
        ...
        panel.setBackground(Color.decode("#aadaf2"));
        frame.add(panel);
        //---------------------------------------------------------

        //-------------------Welcome---------------------------------
        JLabel welcome = new JLabel("Welcome "+getUser(id)+",");
        welcome.setForeground(Color.decode("#aadaf2"));
        ...
        students.setBackground(Color.decode("#aadaf2"));
        students.setForeground(Color.decode("#aadaf2"));
        frame.add(students);
